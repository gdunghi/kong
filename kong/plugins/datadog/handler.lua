...
local function user_metric(message, identifier)
...
local function log(premature, conf, message)
  ...
  local stat_name  = {
    request_size     = format("%s.request.size", api_name),
    response_size    = format("%s.response.size", api_name),
    latency          = format("%s.latency", api_name),
    upstream_latency = format("%s.upstream_latency", api_name),
    kong_latency     = format("%s.kong_latency", api_name),
    request_count    = format("%s.request.count", api_name),
  }
  local stat_value = {
